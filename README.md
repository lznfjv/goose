...
Sure, there are options that provide opportunities for low-level programming of servos and motors, and others that demonstrate basic computer vision filtering techniques.
However, very few kits present the opportunity to thoroughly understand every element of the modern robot. GooseBot, or simply Goose, is an in-development project, designed to be
the ideal educational robotics kit, providing experience with real-world technologies that sticks because the procedures employed are exactly those used in the real-world.
